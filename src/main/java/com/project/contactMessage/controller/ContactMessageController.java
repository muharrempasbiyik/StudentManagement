...
public class ContactMessageController {
    ...
    @DeleteMapping("/deleteById/{contactMessageId}")  // http://localhost:8080/contactMessages/deleteById/3 + DELETE
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    ...
    @DeleteMapping("/deleteByIdParam")  // http://localhost:8080/contactMessages/deleteByIdParam?contactMessageId=2 + DELETE
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
